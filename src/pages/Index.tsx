...
const Index = () => {
  ...
  const artists = [
    ...
    },
    {
      name: "Лиза Шульц",
      genre: "музыкант",
      work: "Совместная работа над образом. За 1 месяц работы с нами сделала +100к просмотров.",
    ...
    },
    {
      name: "МотоТрейд",
      genre: "Компания",
      work: "Работаем не только с артистами, но и с бизнесом. Помогли найти свой формат роликов, благодаря чему увеличили узнаваемость компании. Создание и продвижение канала под ключ с 0: нашли актёра, обучили его, написали текст, сделали монтаж и выложили.",
